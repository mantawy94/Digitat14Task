...
import 'package:new_task/ui/view/eventDetailsScreen/event_details_body.dart';
...
void main() {
  ...
  group('EventDetailsBody', () {
    ...
    testWidgets('EventDetailsBody', (tester) async {
      ...
      await tester.pumpAndSettle();
        ...
        expect(find.textContaining(EventObj.description), findsOneWidget, reason: '>>> description not found');
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          body: EventDetailsBody(eventObject: visit,))
    );
  }
}
